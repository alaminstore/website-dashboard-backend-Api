    ...
    <div class="sidebar-inner slimscrollleft">
        <div id="sidebar-menu">
            <ul>
                ...
                <li>
                    <a class="nav-link waves-effect {{url()->current() == url('/tags')}}" href="{{url('/tags')}}"><i class="fa fa-odnoklassniki"></i><span>Tags</a>
                </li>
                <li>
                    <a class="nav-link waves-effect {{url()->current() == route('backend.catservices')}}" href="{{route('backend.catservices')}}"><i class="mdi mdi-briefcase-check"></i><span>Category Services</a>
                </li>
